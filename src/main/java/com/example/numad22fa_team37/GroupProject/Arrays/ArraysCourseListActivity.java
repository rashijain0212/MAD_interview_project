...
public class ArraysCourseListActivity extends AppCompatActivity implements OnItemClickListener {

    private ArraysCourseListAdapter courseListAdapter;
    private List<TechnicalCourse> courseList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.arrays_main);
        ...
        DatabaseReference mCourseList = mDatabase.child("arrays");
        courseList = new ArrayList<>();
        courseListAdapter = new ArraysCourseListAdapter(courseList, this, this::onItemClick);
        ...
        mCourseList.addValueEventListener(
                new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(ArraysCourseListActivity.this, "Something went wrong go back and try again!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void onItemClick(View view, Integer courseId) {
        ...
        Intent intent = new Intent(this, ArraysTechnicalCourseActivity.class);
