...
public class CourseListAdapter extends RecyclerView.Adapter<CourseListAdapter.RecyclerViewHolder> {

    public final List<TechnicalCourse> courseLst;
    public final Context context;
    public final OnItemClickListener onItemClickListener;

    public CourseListAdapter(List<TechnicalCourse> courseLst, Context context, OnItemClickListener onItemClickListener) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.course_screen_card, parent, false);
