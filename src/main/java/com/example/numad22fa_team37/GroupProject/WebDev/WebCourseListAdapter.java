...
public class WebCourseListAdapter extends RecyclerView.Adapter<WebCourseListAdapter.RecyclerViewHolder> {

    public final List<TechnicalCourse> courseLst;
    public final Context context;
    public final OnItemClickListener onItemClickListener;

    public WebCourseListAdapter(List<TechnicalCourse> courseLst, Context context, OnItemClickListener onItemClickListener) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.web_dev_course_card, parent, false);
